...
class _BookingScreenState extends State<BookingScreen> {
  ...
  void initState() {
    super.initState();
    // Inicia a busca por terapeutas assim que a tela é construída
  ...
  void _onTherapistChanged(TherapistConfigEntity? therapist) {
    setState(() {
      ...
      _selectedSlot = null; // Limpa o horário selecionado
    });
    _fetchSlots();
  }
          ...
          child: Column(
            ...
            children: [
              if (state is AppointmentLoading && state is! AvailableSlotsLoading)
                ...
                _buildTherapistSelector(therapists), // Mostra o dropdown vazio enquanto carrega

              const SizedBox(height: 20),

              // Calendário (simplificado, poderia ser um TableCalendar)
              ListTile(
